...
func TestNewCCPackage(t *testing.T) {
	...
	for {
		...
		exampleccExist = exampleccExist || header.Name == "example_cc/src/main/java/org/hyperledger/fabric/example/SimpleChaincode.java"
	...
	assert.True(t, exampleccExist, "example_cc/src/main/java/org/hyperledger/fabric/example/SimpleChaincode.java does not exists in tar file")
